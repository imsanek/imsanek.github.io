...
$price = $_POST['price'];
$number = $_POST['number'];
$dayCount = $_POST['dayCount'] - 1;


// Формирование самого письма
$title = "Бронирование номера ". $number ." в Бутик-отеле История г. Алушта";
           ...
           <table class="es-footer-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;border-top:1px solid transparent;border-right:1px solid transparent;border-left:1px solid transparent;width:600px;border-bottom:1px solid transparent"> 
             ...
             <tr style="display: flex;"> 
              <td align="left" style="padding:0;Margin:0 auto;padding-top:20px;padding-left:20px;padding-right:20px"> 
               ...
               <table cellpadding="0" cellspacing="0" class="es-left" align="left" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left"> 
                 ...
                 <tr> 
                  <td class="es-m-p0r es-m-p20b" align="center" style="padding:0;Margin:0;width:150px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr> 
                      <td align="center" style="padding:0;Margin:0"><p style="Margin:0; border: 1px solid black;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arvo, courier, georgia, serif;line-height:21px;color:#333333;font-size:14px">' . $number . '</p></td> 
                     </tr> 
                   </table></td> 
                  <td class="es-hidden" style="padding:0;Margin:0;width:20px"></td> 
                 </tr> 
               ...
               <table cellpadding="0" cellspacing="0" class="es-left" align="left" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left"> 
                 ...
                 <tr> 
                  <td class="es-m-p20b" align="center" style="padding:0;Margin:0;width:125px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr> 
                      <td align="center" style="padding:0;Margin:0"><p style="Margin:0; border: 1px solid black;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arvo, courier, georgia, serif;line-height:21px;color:#333333;font-size:14px">' . $dayCount .  '</p></td> 
                     </tr> 
                   </table></td> 
                  <td class="es-hidden" style="padding:0;Margin:0;width:20px"></td> 
                 </tr> 
               ...
               <table cellpadding="0" cellspacing="0" class="es-left" align="left" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:right"> 
                 <tr> 
                  <td class="es-m-p20b" align="center" style="padding:0;Margin:0;width:125px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr> 
                 ...
                 <tr> 
                  <td class="es-m-p20b" align="center" style="padding:0;Margin:0;width:125px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr> 
                      <td align="center" style="padding:0;Margin:0"><p style="Margin:0; border: 1px solid black;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arvo, courier, georgia, serif;line-height:21px;color:#333333;font-size:14px">' . $price/$dayCount . ' руб.</p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table> 
               ...
               <table cellpadding="0" cellspacing="0" class="es-right" align="right" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:right"> 
                 ...
                 <tr> 
                  <td align="center" style="padding:0;Margin:0;width:125px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr> 
                      <td align="center" style="padding:0;Margin:0"><p style="Margin:0; border: 1px solid black;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arvo, courier, georgia, serif;line-height:21px;color:#333333;font-size:14px">' . $price . '</p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table> 
                  ...
                  <td align="center" valign="top" style="padding:0;Margin:0;width:558px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     ...
                     <tr> 
                      ...
                      font-size: 16px;
    float: left;
                  ">Всего к оплате по счёту (предоплата: 20%): ' . $price * 0.2 . ' руб.</span> <br><br>
                      <span style="
                      padding: 10px;
                      font-weight: bold;
                      font-family: arvo, courier, georgia, serif;
                      ...
                      font-size: 16px;
    float: left;
                  ">Задолженность (оплачивается при поселении): ' . $price * 0.8 . ' руб.</span> <br><br>
                      <span style="
                      padding: 10px;
                      font-weight: bold;
                      font-family: arvo, courier, georgia, serif;
                      ...
                      font-size: 16px;
    float: left;
                  ">Реквезиты для внесения предоплаты (20%): ' . $price * 0.2 . ' руб.</span> <br><br>
                      <tr>
                          <td style="
          ...
          ">Назначение платежа</td>
              ...
              border: 1px solid black;
              padding: 10px;font-family:arvo, courier, georgia, serif;line-height:21px;color:#333333;font-size:14px
          ">Бронирование номера ' . $number . ' в Бутик-отеле История</td>
                      </tr>
                  </table><br><br>
                  
                  <p style="margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;font-family:arvo, courier, georgia, serif;line-height:21px;color:#333333;font-size: 17px;">Когда Вы оплатите счёт, нажмите на эту кнопку.</p></td> 
                     </tr> 
                     <tr> 
                      <td align="center" style="padding:10px;Margin:0"><span class="es-button-border" style="border-style:solid;border-color:#2CB543;background:#2CB543;border-width:0px 0px 2px 0px;display:inline-block;border-radius:6px;width:auto"><a href="https://hotel-istoria.ru/payment.html?name='. $name .'&number='. $number .'&email='. $email .'&firstDate='. $firstDate .'&lastDate='. $lastDate .'&price='. $price * 0.2  .'" class="es-button es-button-1" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;border-style:solid;border-color:#31CB4B;border-width:5px 55px;display:inline-block;background:#31CB4B;border-radius:6px;font-family:arvo, courier, georgia, serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center">Я оплатил</a></span></td> 
                     </tr> 
                     <tr> 
